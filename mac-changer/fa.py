...
def add(dict1):
    name3 = input("Enter the new name you want to add: ")
...
def search(dict1, n, list1, temp):
    name2 = input("Enter the name whose number is to be found: ")
    for i in range(0, n):
        if list1[i] == name2:
            temp = i
    if temp != 100:
        print
        "Number is : ", list2[temp]


def delete(dict1):
    name4 = input("Enter the name you want to delete: ")
    del dict1[name4]
    print
    dict1
...
def update(dict1, n, list1):
    name5 =input("Enter the name which you want to update: ")
    for i in range(0, n):
        if list1[i] == name5:
            temp = i
    if temp != 100:
